app.controller('PlayerDetailsCtrl', ['$scope', 'StatsService', '$routeParams', 'MatchesService', 'GamesService', function ($scope, StatsService, $routeParams, MatchesService, GamesService) {
